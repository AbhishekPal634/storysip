        ...
        <div className="flex flex-col lg:flex-row items-center">          
          ...
          <div className="lg:w-1/2 lg:pl-12">
            <h2 className="font-['Playfair_Display',serif] text-4xl md:text-5xl font-bold mb-4 text-gray-800">
              This Month's <span className="italic">Selection</span>
            </h2>
            <p className="text-gray-700 mb-6 max-w-lg leading-relaxed">
              Discover our carefully curated selection of this month's most captivating reads. 
              From thought-provoking literary fiction to insightful non-fiction, 
              we've handpicked titles that promise to inspire and entertain.
            </p>
            <Link to="/books" 
