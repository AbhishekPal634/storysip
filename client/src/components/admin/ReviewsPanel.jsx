...
function ReviewsPanel({ reviews, onDeleteReview }) {
  return (
    <div>
      ...
      <div className="space-y-4">
        {reviews.map((review) => (
          <div
            ...
            className="bg-white shadow-sm rounded-lg overflow-hidden border border-amber-100 hover:shadow-md transition-shadow"
          >
            <div className="p-5">
